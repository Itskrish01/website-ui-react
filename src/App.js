      ...
      <div className="w-auto">
        <div className="flex flex-wrap items-center">
          <div className="w-auto mr-14">
            <a href="#">
              <img src="assets/flaro-assets/logos/flaro-logo-black.svg" alt="" />
            </a>
          </div>
    ...
    <div className="container px-4 mx-auto">
        ...
        <div className="relative z-20 flex flex-wrap items-end -m-8">
          <div className="w-full lg:w-1/2 lg:pr-0 lg:pl-28 lg:py-28 px-16 py-4 mt-12">
            ...
            <div className="mb-6 md:inline-block">
              <button className="py-4 px-6 w-full font-semibold border border-indigo-700 rounded-xl focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200 text-white" type="button">LEARN MORE</button>
            </div>

          </div>
          <div className="w-full lg:w-1/2 p-8">
            <img src="assets/flaro-assets/images/headers/profiles.png" alt="" />
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-center items-center -m-8">
        <div className="w-auto p-8">
          <img src="assets/flaro-assets/logos/brands/brand-xl.png" alt="" />
        </div>
        <div className="w-auto p-8">
          <img src="assets/flaro-assets/logos/brands/brand-xl-2.png" alt="" />
        </div>
        <div className="w-auto p-8">
          <img src="assets/flaro-assets/logos/brands/brand-xl-3.png" alt="" />
        </div>
        <div className="w-auto p-8">
          <img src="assets/flaro-assets/logos/brands/brand-xl-4.png" alt="" />
        </div>
        <div className="w-auto p-8">
          <img src="assets/flaro-assets/logos/brands/brand-xl-5.png" alt="" />
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="flex flex-wrap max-w-5xl mx-auto -m-3">
      <div className="w-full md:w-1/3 p-3">
        <div className="py-8 px-12 h-full text-center bg-white rounded-xl">
          <h2 className="mb-3 text-6xl md:text-8xl xl:text-10xl text-indigo-600 text-center font-bold font-heading tracking-px-n leading-none">41,300+</h2>
          <p className="text-gray-700 font-medium leading-relaxed">Flaro has garnered more than 15k+ users.</p>
        </div>
      </div>
      <div className="w-full md:w-1/3 p-3">
        <div className="py-8 px-12 h-full text-center bg-white rounded-xl">
          <h2 className="mb-3 text-6xl md:text-8xl xl:text-10xl text-indigo-600 text-center font-bold font-heading tracking-px-n leading-none">83k</h2>
          <p className="text-gray-700 font-medium leading-relaxed">Flaro has garnered more than 15k+ users.</p>
        </div>
      </div>
      <div className="w-full md:w-1/3 p-3">
        <div className="py-8 px-12 h-full text-center bg-white rounded-xl">
          <h2 className="mb-3 text-6xl md:text-8xl xl:text-10xl text-indigo-600 text-center font-bold font-heading tracking-px-n leading-none">2019</h2>
          <p className="text-gray-700 font-medium leading-relaxed">Flaro has garnered more than 15k+ users.</p>
        </div>
      </div>
    </div>
    ...
    <div className="flex flex-wrap lg:items-center -m-8 lg:-m-14">
      <div className="w-full md:w-1/2 p-8 lg:p-14">
        <div className="relative max-w-max mx-auto lg:ml-auto lg:mr-0 overflow-hidden rounded-4xl">
          <img className="transform hover:scale-105 transition ease-in-out duration-1000" src="assets/flaro-assets/images/team/bg3.png" alt="" />
      ...
      <div className="w-full md:w-1/2 p-8 lg:p-14">
        <div className="md:max-w-sm">
          ...
          <h2 className="mb-8 text-6xl md:text-8xl xl:text-10xl font-bold font-heading tracking-px-n leading-none">Ronald Richards</h2>
          <p className="mb-7 text-lg text-gray-900 font-medium">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat.</p>
